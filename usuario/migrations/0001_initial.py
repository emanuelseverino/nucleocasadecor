    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seguimento', models.CharField(max_length=40, verbose_name='Seguimento')),
                ('tipo', models.CharField(choices=[('EMPRESA', 'Empresa'), ('ESPECIFICADOR', 'Especificador')], default='EMPRESA', max_length=20)),
